...
@oclif/plugin-commands/4.1.35 linux-x64 node-v20.19.5
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.35/src/commands/commands.ts)_
