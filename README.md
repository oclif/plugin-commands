...
@oclif/plugin-commands/4.1.24 linux-x64 node-v20.19.0
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.24/src/commands/commands.ts)_
