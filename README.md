...
@oclif/plugin-commands/4.1.46 linux-x64 node-v20.20.2
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.46/src/commands/commands.ts)_
