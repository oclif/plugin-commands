...
@oclif/plugin-commands/4.1.61 linux-x64 node-v22.23.1
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.61/src/commands/commands.ts)_
<!-- commandsstop -->
