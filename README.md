...
@oclif/plugin-commands/3.1.2 linux-x64 node-v18.19.0
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.1.2/src/commands/commands.ts)_
