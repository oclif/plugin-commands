...
@oclif/plugin-commands/3.0.5 linux-x64 node-v18.18.2
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.0.5/src/commands/commands.ts)_
