...
@oclif/plugin-commands/3.1.1 linux-x64 node-v18.19.0
...
_See code: [lib/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.1.1/lib/commands/commands.ts)_
