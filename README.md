...
@oclif/plugin-commands/4.2.0 linux-x64 node-v22.23.2
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.2.0/src/commands/commands.ts)_
<!-- commandsstop -->
