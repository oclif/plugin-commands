...
@oclif/plugin-commands/3.3.0 linux-x64 node-v18.20.1
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.3.0/src/commands/commands.ts)_
