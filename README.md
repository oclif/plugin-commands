...
@oclif/plugin-commands/4.1.17 linux-x64 node-v20.18.1
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.17/src/commands/commands.ts)_
