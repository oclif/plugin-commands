...
@oclif/plugin-commands/4.0.1 linux-x64 node-v18.20.3
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.0.1/src/commands/commands.ts)_
