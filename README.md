...
@oclif/plugin-commands/3.3.2 linux-x64 node-v18.20.2
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.3.2/src/commands/commands.ts)_
