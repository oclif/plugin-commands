...
@oclif/plugin-commands/4.1.19 linux-x64 node-v20.18.2
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.19/src/commands/commands.ts)_
