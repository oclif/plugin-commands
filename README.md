...
@oclif/plugin-commands/4.1.0 linux-x64 node-v18.20.4
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/4.1.0/src/commands/commands.ts)_
