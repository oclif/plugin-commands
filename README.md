...
@oclif/plugin-commands/3.1.4 linux-x64 node-v18.19.0
...
_See code: [src/commands/commands.ts](https://github.com/oclif/plugin-commands/blob/3.1.4/src/commands/commands.ts)_
