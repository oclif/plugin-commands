...
```bash
$ git clone git@github.com:oclif/plugin-commands.git
```

**2. Navigate into project & install development-specific dependencies...**

```bash
$ cd ./plugin-commands && yarn
```
...
**6. Open a [Pull Request](https://github.com/oclif/plugin-commands/pulls) for your work & become the newest contributor to `@oclif/plugin-commands`! 🎉**
